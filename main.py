...
app.config['SQLALCHEMY_DATABASE_URI'] = "mysql+pymysql://blogz:nopassw0rd@localhost:8889/blogz"
app.config['SQLALCHEMY_ECHO'] = True
db = SQLAlchemy(app)
app.secret_key = "Drmhze6EPcv0fN_81BjQnA"
...
def blog():
    ...
    if user_id:
        entries = Blogz.query.filter_by(owner_id=user_id)
